...
import com.myapplication.ui.theme.KotlinBasicsTheme
...
private fun week03Collections() {
    ...
    Log.d("KotlinWeek03" ,"Mutalble Fruits : $mutableFruits")
    ...
    scores.forEach{(name, score) -> Log.d("KotlinWeek03", "$name scroed: $score")}
}
